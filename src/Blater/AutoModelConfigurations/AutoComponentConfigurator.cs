...
namespace Blater.AutoModelConfigurations;

[SuppressMessage("Performance", "CA1859:Usar tipos concretos quando possível para melhorar o desempenho")]
public class AutoComponentConfigurator : IAutoComponentPropertyConfigurator
{
    ...
    {
        CurrentComponentConfiguration.ComponentTypes[show] = formType;
    ...
    {
        CurrentComponentConfiguration.ComponentTypes[show] = componentType;
